  ...
  return (
    <Popover className="relative">
      <Popover.Button className="inline-flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900">
        <span>
        <img class="object-cover w-9 h-9 mt-[6px] rounded-full" src={me} alt="Profile picture"/>
        </span>
      </Popover.Button>
          ...
          <div className="w-screen max-w-sm flex-auto overflow-hidden rounded-[.6rem] bg-white text-sm leading-6 shadow-lg ring-1 ring-gray-900/5">
            <div className="p-4">
              ...
              <div key={''} className="group relative flex gap-x-6 rounded-lg p-4 border-b">
                  ...
                  <img class="object-cover w-12 h-12 mt-[6px] rounded-full" src={me} alt="Profile picture"/>
                  </div>
                  <div>
